...
import { Bell, Sparkles, History } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      <View style={styles.iconContainer}>
        <View style={styles.iconBackground}>
          <Bell size={48} color="#3b82f6" strokeWidth={1.5} />
      ...
      {onHistorical && (
        <TouchableOpacity style={styles.linkButton} onPress={onHistorical}>
          ...
          <Text style={styles.linkText}>
            ...
            <Text style={styles.linkUnderline}>Go to historical notifications.</Text>
          </Text>
        </TouchableOpacity>
      )}
    </View>
