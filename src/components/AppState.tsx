...
export function AppEmptyState({ title, description, iconName = 'ClipboardList', role = 'default' }: AppStateProps) {
  const roleTheme = getRoleTheme(role);
  return (
    <View style={styles.wrap}>
      <View style={[styles.iconWrap, { backgroundColor: roleTheme.soft }]}>
        <AppIcon name={iconName} color={roleTheme.primary} />
      </View>
...
export function AppErrorState({ title, description, iconName = 'TriangleAlert', role = 'default' }: AppStateProps) {
  const roleTheme = getRoleTheme(role);
  return (
    <View style={styles.wrap}>
      <View style={[styles.iconWrap, { backgroundColor: roleTheme.soft }]}>
        <AppIcon name={iconName} color={roleTheme.primaryDark} />
      </View>
      <AppText variant="body" weight="semibold" style={styles.centerText}>
        {title}
      </AppText>
