...
import { UserInviteQRData, AttendanceQRData, EventInviteQRData, QRCodeRecord } from '@/types/qr';
...
export const generateSampleQRCodes = (adminId: string) => {
  return {
    userInvite: generateUserInviteQR('Mahaka Solutions', 'Admin User', adminId, 'user'),
    attendance: generateAttendanceQR('Main Entrance', 'OFFICE_001', adminId),
    event: generateEventInviteQR(
      'Team Meeting',
